  ...
  try {
    ...
    if (Number(fundingCount[0]?.count || 0) === 0) {
      await db.insert(fundingSources).values([
        ...
        { name: "Corporate Sponsors", type: "revenue", projectedAmount: "120000.00", receivedAmount: "85000.00", fiscalYear: "2025-2026", notes: "Major regional GCs, utilities, and corporate partners — annual sponsorship agreements" },
