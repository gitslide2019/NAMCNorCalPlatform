...
export const smsContacts = pgTable("sms_contacts", {
  ...
  googleSearchUrl: text("google_search_url"),
  specialties: text("specialties"),
  outreachDescription: text("outreach_description"),
  projectFocus: text("project_focus"),
  energyRelevance: text("energy_relevance"),
  whyNamcRelevant: text("why_namc_relevant"),
  membershipValue: text("membership_value"),
  membershipPitch: text("membership_pitch"),
  bestOutreachAngle: text("best_outreach_angle"),
  smsTemplate: text("sms_template"),
  emailTemplate: text("email_template"),
  preferredContactName: text("preferred_contact_name"),
  professionalSalutation: text("professional_salutation"),
  primaryLicenseTypes: text("primary_license_types"),
  status: text("status").notNull().default("active"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
