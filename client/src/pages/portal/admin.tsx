  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          <RenewalGroupCard title="Overdue" icon={<AlertCircle className="h-5 w-5 text-red-600" />} group={overdue} groupKey="overdue" colorClass="bg-red-100 dark:bg-red-900/30" description="Membership has already expired — send a reminder immediately" isOpen={!!openGroups["overdue"]} onToggle={(open) => toggleGroup("overdue", open)} {...shared} />
          <RenewalGroupCard title="Due in 30 Days" icon={<CalendarClock className="h-5 w-5 text-amber-600" />} group={due30} groupKey="due-30" colorClass="bg-amber-100 dark:bg-amber-900/30" description="Renewal coming up within the next 30 days" isOpen={!!openGroups["due-30"]} onToggle={(open) => toggleGroup("due-30", open)} {...shared} />
